...
<div className="absolute inset-0 bg-black/60 -z-10" />
      ...
      <motion.div
        ...
        className="relative max-w-md w-full mx-6 rounded-3xl border border-white/10 
                   bg-white/5 backdrop-blur-2xl p-10 text-center shadow-[0_0_120px_rgba(212,175,55,0.15)]"
      >

        {/* Badge */}
        <div className="absolute -top-0.5 left-1/2 -translate-x-1/2 px-2 py-1 rounded-full
                        text-xs tracking-widest bg-black/60 border border-[#D4AF37]/30
                        text-[#D4AF37]">
          WEB3 ACCESS GATE
        </div>
