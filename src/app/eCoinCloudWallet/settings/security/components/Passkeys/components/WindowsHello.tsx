...
export default function WindowsHello() {
  return (
    <div className="bg-neutral-900/40 p-3 rounded-xl border border-white/5 flex items-center justify-between font-mono">
      <div className="flex items-center gap-3">
        ...
        <div>
          <span className="text-xs font-bold text-white block">Windows Hello</span>
          <span className="text-[9px] text-neutral-500">PIN & Reconhecimento Facial</span>
        </div>
      </div>
