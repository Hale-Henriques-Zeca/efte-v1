  ...
  return (
    <div className="bg-neutral-900/40 p-3.5 rounded-xl border border-white/5 flex items-center justify-between font-mono">
      <div className="flex items-center gap-3">
        ...
        <div>
          <span className="text-xs font-bold text-white block">Authenticator App (TOTP)</span>
          <span className="text-[10px] text-neutral-500">Google Authenticator / 1Password</span>
        </div>
      </div>
