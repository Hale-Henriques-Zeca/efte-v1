...
export default function DatabaseKYCPage() {
  return (
      ...
      <div className="w-full space-y-6 bg-slate-900/90 border border-slate-800/90 rounded-3xl p-6 md:p-8 shadow-2xl relative z-10 backdrop-blur-xl">
        ...
        <div className="border-b border-slate-800/80 pb-5">
          ...
          <p className="text-slate-400 text-sm mt-1.5">
            Envie e acompanhe os seus documentos de identificação civil e comprovativo de residência para credenciamento off-chain.
          </p>
        </div>
