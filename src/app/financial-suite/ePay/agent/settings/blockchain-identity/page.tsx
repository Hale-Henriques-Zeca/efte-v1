import { WalletCard, NFTIdentity, IdentityCard, ReferralCard } from './Components';
        ...
        <div className="border-b border-slate-800/80 pb-5">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[11px] font-bold uppercase tracking-widest text-emerald-400 ml-1">
              On-Chain Identity & Web3 Profile
            </span>
          </div>
          ...
          <p className="text-slate-400 text-sm mt-1.5">
            Sua credencial soberana e imutável na rede ePay. Conecte sua carteira Web3, gerencie seu ID em NFT e link de indicação.
          </p>
        </div>
