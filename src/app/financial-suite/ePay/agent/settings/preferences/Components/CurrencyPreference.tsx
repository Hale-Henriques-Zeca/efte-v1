...
export const CurrencyPreference: React.FC = () => {
  ...
  return (
    <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-6 backdrop-blur-md space-y-4">
      <h3 className="text-sm font-bold uppercase tracking-wider text-amber-400 border-b border-slate-800/80 pb-2 flex items-center gap-2">
        ...
        Moeda de Exibição Fiat / Cripto
      </h3>

      <p className="text-xs text-slate-400">
        Defina a moeda base para visualização de saldos, relatórios de comissão e liquidações.
      </p>
      ...
      <div className="space-y-3">
        <div>
          ...
          <select
            ...
            className="w-full bg-slate-950/80 border border-slate-800 rounded-xl px-4 py-2.5 text-slate-100 text-sm focus:outline-none focus:border-amber-500/50 cursor-pointer"
          >
            <option value="MZN">Metical (MZN)</option>
            <option value="USD">US Dollar (USD)</option>
            <option value="EUR">Euro (EUR)</option>
            <option value="eCoin">eCoin (eC)</option>
          </select>
        </div>
